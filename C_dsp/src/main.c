...
int main(void)
{
    ...
    g_FIR_1.symmetric = true;
    g_FIR_1.coeff_b_len = Filter_1_N_FIR_B;
    g_FIR_1.coeff_a_len = Filter_1_N_FIR_A;
    g_FIR_1.coeff_a_ptr = Filter_1_a_fir;
    g_FIR_1.coeff_b_ptr = Filter_1_b_fir;

    FIR_filter_t g_FIR_2;
    g_FIR_2.symmetric = true;
    g_FIR_2.coeff_b_len = Filter_2_N_FIR_B;
    g_FIR_2.coeff_a_len = Filter_2_N_FIR_A;
    g_FIR_2.coeff_a_ptr = Filter_2_a_fir;
    g_FIR_2.coeff_b_ptr = Filter_2_b_fir;
